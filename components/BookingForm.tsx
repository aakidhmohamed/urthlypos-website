                    ...
                    <FadeIn>
                        ...
                        <div className="p-6 rounded-2xl bg-surface border border-border/50 backdrop-blur-sm">
                            ...
                            <a
                                ...
                                className="w-full flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#20bd5a] text-white py-3.5 rounded-xl font-heading font-bold transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 active:scale-95 focus-ring"
                            >
                            ...
                            {!isSuccess ? (
                                ...
                                <FadeIn>
                                    <div className="flex flex-col items-center justify-center text-center py-8 space-y-6 animate-in fade-in zoom-in duration-500">
                                        <div className="w-20 h-20 bg-green-500/10 rounded-full flex items-center justify-center mb-2 relative">
                                            <div className="absolute inset-0 bg-green-500/20 rounded-full animate-ping opacity-75"></div>
                                            <MessageCircle className="w-10 h-10 text-green-500 fill-green-500" />
                                        </div>

                                        <div>
                                            <h3 className="text-2xl font-heading font-bold text-white mb-2">Almost Done! 🚀</h3>
                                            <p className="text-text-muted max-w-sm mx-auto">
                                                To finalize your booking, please click the button below to send your details to our team via WhatsApp.
                                            </p>
                                        </div>

                                        <a
                                            href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
                                                `Hello, I would like to request a free demo for Urthly POS.\n\n*My Details:*\nName: ${formState.name}\nPhone: ${formState.phone}\nBusiness Type: ${formState.businessType}\n\nPlease let me know the available time slots.`
                                            )}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="w-full bg-[#25D366] hover:bg-[#20bd5a] text-white font-heading font-bold py-4 rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-3 group focus-ring"
                                            onClick={() => {
                                                // Optional: Reset form after valid click if needed, or keep it as is
                                        ...
                                        <button
                                            ...
                                            className="text-sm text-text-dim hover:text-text-muted underline transition-colors"
                                        >
                                            Edit my details
                                        </button>
                                    </div>
