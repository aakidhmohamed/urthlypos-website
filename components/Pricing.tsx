        ...
        <div className="text-center mb-16">
          ...
          <FadeIn delay={200}>
            <p className="text-text-muted max-w-xl mx-auto text-lg">
                Stop paying monthly subscriptions. Get the full power of OfflinePOS with a single one-time payment.
            </p>
          </FadeIn>
        </div>
            ...
            >
              ...
              <div className="mb-8 text-center md:text-left">
                  ...
                  <div className="flex items-baseline justify-center md:justify-start gap-1">
                      {plan.price !== 'Custom' && <span className="text-2xl font-medium text-text-dim">$</span>}
