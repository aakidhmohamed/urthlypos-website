    ...
    <section id="features" className="py-24 relative bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          <FadeIn>
            <span className="text-sm font-heading font-bold tracking-widest text-primary uppercase mb-4 block">Power Packed Features</span>
          </FadeIn>
          <FadeIn delay={100}>
            <h2 className="text-4xl md:text-5xl font-heading font-extrabold text-text mb-6">
              Everything You Need to <br/>
              <span className="text-primary italic">Run Your Shop Efficiently</span>
            </h2>
          </FadeIn>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <FadeIn delay={200} className="bg-surface p-8 rounded-3xl border border-border md:col-span-1 group hover:border-primary/50 transition-all duration-300 ease-premium hover:-translate-y-1 hover:shadow-lift h-full">
                ...
                <h4 className="text-xl font-heading font-bold text-text mb-2">Detailed Analytics</h4>
            ...
            <FadeIn delay={300} className="bg-surface p-8 rounded-3xl border border-border md:col-span-2 relative overflow-hidden group hover:border-primary/50 transition-all duration-300 ease-premium hover:-translate-y-1 hover:shadow-lift h-full">
                ...
                <div className="relative z-10 flex flex-col h-full justify-between">
                    <div>
                        <div className="flex items-center gap-3 mb-8">
                             <div className="p-2 bg-background border border-border rounded-lg group-hover:border-primary/30 transition-colors"><WifiOff className="w-6 h-6 text-text" /></div>
                             <h4 className="text-2xl font-heading font-bold text-text">Works 100% Offline</h4>
                        </div>
                        
                        <p className="text-text-muted text-lg leading-relaxed max-w-lg mb-8">
                             Never stop selling. Our robust offline-first architecture ensures your business keeps running even when the internet goes down. Data syncs automatically when you reconnect.
                        </p>
                    </div>

                    {/* Visual Representation */}
                    <div className="flex gap-4 items-center self-start">
                        <div className="bg-surface border border-primary/30 text-text px-6 py-3 rounded-xl shadow-sm flex items-center gap-3 group-hover:border-primary transition-colors">
                        ...
                        <div className="w-16 h-0.5 border-t-2 border-dashed border-border group-hover:border-primary/30 transition-colors"></div>
